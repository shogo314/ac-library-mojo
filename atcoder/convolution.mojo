...
struct _FFTInfo[M: Int]:
    ...
    fn __init__(out self):
        ...
        self.root = List[mint](length=rank2 + 1, fill=mint())
        self.iroot = List[mint](length=rank2 + 1, fill=mint())
        self.rate2 = List[mint](length=max(0, rank2 - 1), fill=mint())
        self.irate2 = List[mint](length=max(0, rank2 - 1), fill=mint())
        self.rate3 = List[mint](length=max(0, rank2 - 2), fill=mint())
        self.irate3 = List[mint](length=max(0, rank2 - 2), fill=mint())
